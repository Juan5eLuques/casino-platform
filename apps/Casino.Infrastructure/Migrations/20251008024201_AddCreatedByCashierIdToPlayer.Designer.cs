...
namespace Casino.Infrastructure.Migrations
{
    ...
    [Migration("20251008024201_AddCreatedByCashierIdToPlayer")]
    partial class AddCreatedByCashierIdToPlayer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Casino.Domain.Entities.Player", b =>
                {
                    ...
                    b.Property<Guid?>("CreatedByCashierId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Casino.Domain.Entities.Player", b =>
                {
                    ...
                    b.HasOne("Casino.Domain.Entities.BackofficeUser", "CreatedByCashier")
                        .WithMany()
