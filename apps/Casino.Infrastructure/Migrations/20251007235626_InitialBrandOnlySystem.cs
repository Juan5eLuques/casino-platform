...
{
    /// <inheritdoc />
    public partial class InitialBrandOnlySystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminDomain = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CorsOrigins = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentCashierId = table.Column<Guid>(type: "uuid", nullable: true),
                    CommissionRate = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackofficeUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BackofficeUsers_BackofficeUsers_ParentCashierId",
                        column: x => x.ParentCashierId,
                        principalTable: "BackofficeUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BackofficeUsers_Brands_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BackofficeUsers_BrandId",
                table: "BackofficeUsers",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_BackofficeUsers_ParentCashierId",
                table: "BackofficeUsers",
                column: "ParentCashierId");
